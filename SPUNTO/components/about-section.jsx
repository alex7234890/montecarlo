      ...
      <div className="max-w-7xl mx-auto px-4">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className={`relative transition-all duration-1000 ${inView ? "animate-slide-in-left" : "opacity-0"}`}>
            ...
            {/* Floating Stats Card */}
            <div className="absolute -bottom-6 -right-6 glass rounded-xl p-6 animate-pulse-glow">
              <p className="font-heading text-4xl text-primary">320+</p>
              <p className="text-muted-foreground text-sm">Tesserati nella stagione corrente</p>
            </div>
          </div>
