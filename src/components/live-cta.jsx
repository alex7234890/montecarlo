        ...
        <div className={`grid lg:grid-cols-2 gap-16 items-center transition-all duration-1000 ${inView ? "opacity-100" : "opacity-0"}`}>
          ...
          <div className={`transition-all duration-1000 delay-300 ${inView ? "animate-slide-in-right" : "opacity-0"}`}>
            <div className="relative">
              ...
              <div className="absolute -top-2 -right-2 sm:-top-4 sm:-right-4 glass rounded-xl p-3 sm:p-4 animate-bounce max-w-[180px] sm:max-w-none" style={{ animationDuration: "3s" }}>
                <div className="flex items-center gap-2 sm:gap-3">
                  <Bell className="text-primary shrink-0" size={16} />
                  <div>
                    <p className="text-foreground text-[10px] sm:text-xs font-semibold">Partita iniziata!</p>
                    <p className="text-muted-foreground text-[9px] sm:text-[10px]">Pulcini vs FC Riviera</p>
                  </div>
                </div>
              </div>
            </div>
