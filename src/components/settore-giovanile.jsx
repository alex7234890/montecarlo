          ...
          <div className="relative rounded-2xl overflow-hidden h-[400px] lg:h-[550px]">
            ...
            <div className="absolute bottom-4 left-4 right-4 sm:bottom-6 sm:left-6 sm:right-6">
              <div className="glass rounded-xl p-4 sm:p-5">
                <h3 className="font-heading text-2xl sm:text-3xl md:text-4xl text-foreground">{teams[activeTeam].name}</h3>
                <p className="text-primary font-semibold text-xs sm:text-sm">{teams[activeTeam].ages}</p>
                <p className="text-muted-foreground text-xs sm:text-sm mt-2 leading-relaxed">{teams[activeTeam].desc}</p>
              </div>
            </div>
          </div>
          ...
          <div className="flex flex-col gap-4">
            {teams.map((team, i) => (
              <button
                ...
                className={`group text-left p-4 sm:p-6 rounded-xl transition-all duration-500 ${
                  activeTeam === i
              ...
              >
                <div className="flex items-center justify-between">
                  <div>
                    <h3 className={`font-heading text-2xl sm:text-3xl transition-colors duration-300 ${
